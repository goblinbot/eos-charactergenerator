...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 08 feb 2018 om 23:53
...
(31013, 'Ballistiek amateur', 'guns_2', 12000, 2, 1, 'Je kan omgaan met semi-automatische pistolen en jachtgeweren, vaak geladen met een\r\nintern magazijn. Dit is het niveau van de meeste wetshandhavers, sportschutters,\r\nsportjagers en coloniale milities op zitten. Je mag op dit niveau ook archaÃ¯sche wapens\r'),
(31014, 'Ballistiek professional', 'guns_3', 12000, 3, 1, 'Je kan omgaan met semi-automatische wapens met variabele magazijnen, en kent de basis\r\nvan standaard explosieven zoals granaten. Vrijwel alle militairen trainen tot minimaal dit\r\nniveau ongeacht factie, en vaak zijn prive-beveiligers en huurlingen ook op '),
...
--
ALTER TABLE `ecc_char_sheet`
  MODIFY `charSheetID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
