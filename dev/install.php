        ...
        if(isset($_GET['check']) && $_GET['check'] == true) {
          ...
          if(mysqli_num_rows($res) == 0) {
            ...
            $sql = "INSERT INTO `ecc_skills_allskills` (`skill_id`, `label`, `skill_index`, `parent`, `level`, `version`, `description`) VALUES
              ...
              (31092, 'Leapfrogging', 'tacticus_6', 12016, 6, 1, 'Op het bevel â€œleapfrogging!â€ geeft je team cover aan 1 persoon van je team die dag maximaal 5 stappen onzichtbaar. 2 x per combat'),
              (31093, 'Centre Peel', 'tacticus_7', 12016, 7, 1, 'Je team heeft cover aan 2 personen die zich onzichtbaar mogen terugtrekken. 1 x per combat'),
              (31094, 'Call in the Specialist', 'tacticus_8', 12016, 8, 1, 'Dit is een zeer ervaren compaan met precies de slagvaardigheid heeft die je nodig hebt voor de missie. Dit is een DPC voor 1 missie of special, 1x per weekend.\r\nHet heeft onze sterke voorkeur dat je een medespeler vraagt om deze DPC tijdelijk te spelen - we zetten hier voor alleen NPCâ€™s in als het noodzakelijk is. Onze motivatie\r\n hier in is dat zo ook non-combat spelers mee kunnen gaan op het slagveld of missie en eventueel zelfs een vaste DPC rol kunnen krijgen als de samenwerking bevalt.'),
              (31095, 'Hammer-And-Anvil', 'tacticus_9', 12016, 9, 1, 'Je mag als leider max 2 andere personen aantikken die onzichtbaar naar een vooraf door jou gespecificeerde beschutte plek mogen lopen. 1 x per dag.'),
