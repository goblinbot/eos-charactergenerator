...
join jml_eb_field_values v5 on (v5.registrant_id = r.id and v5.field_id = 14)
    ...
    where r.event_id = $EVENTID and v5.field_value = 'speler' and v2.field_value NOT LIKE 'medische%' AND ((r.published = 1 AND (r.payment_method = 'os_ideal' or r.payment_method = 'os_paypal')) OR (r.published in (0,1) AND r.payment_method = 'os_offline'))
    UNION
/*
...
where r.event_id = $EVENTID and v5.field_value = 'speler' and v2.field_value LIKE 'medische%' and ((r.published = 1 AND (r.payment_method = 'os_ideal' OR r.payment_method = 'os_paypal')) OR
