...
CONCAT(COALESCE(v4.field_value,''),COALESCE(v3.field_value,'')) as tweede_room from joomla.jml_eb_registrants r
...
where v5.field_value != 'Speler' AND r.event_id = 15 and ((r.published = 1 AND (r.payment_method = 'os_ideal' OR r.payment_method = 'os_paypal')) OR 
